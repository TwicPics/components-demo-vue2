...
Thanks to the open source [TwicPics](https://www.twicpics.com/?utm_source=github&utm_medium=organic&utm_campaign=components) Components, delivering responsive images in your [Vue 2](https://v2.vuejs.org/) projects has never been easier.
...
TwicPics components for `Vue2` comes as an `Vue2 Plugin` and is configured as [such](https://v2.vuejs.org/v2/guide/plugins.html#Using-a-Plugin).
...
All the examples proposed in this project are located in the `components` directory.
